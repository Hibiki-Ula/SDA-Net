    ...
    for epoch in range(start_epoch, config.max_epoch + 1):
        ...
        for idx, (taxonomy_ids, model_ids, data) in enumerate(train_dataloader):
            ...
            if  'PCN' in dataset_name or dataset_name == 'Completion3D' or 'ProjectShapeNet' in dataset_name:
                ...
                # partial, m ,center = misc.pc_norm(data)
                # gt = misc.pc_norm_gt(gt, m, center)
        ...
        for idx, (taxonomy_ids, model_ids, data) in enumerate(test_dataloader):
            ...
            if  'PCN' in dataset_name or 'ProjectShapeNet' in dataset_name:
                ...
                for item in choice:           
                    ...
                    # pts0 = partial.cpu().numpy()
                    # misc.saveptstxt(pts0, taxonomy_ids[0], model_ids[0])
                    # pts1 = ret[-1].cpu().numpy()
                    # misc.saveptstxt(pts1, taxonomy_ids[0], model_ids[0]+'complete')
